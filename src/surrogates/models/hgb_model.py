...
class HGB(BaseSurrogateModel):
    ...
    def __init__(self, max_iter=200, learning_rate=0.05, random_state=42, max_depth=4, l2_regularization=1e-3, early_stopping="auto",validation_fraction=0.1):
        """
    ...
    def fit(self, X, y):
        """
        Ajusta el HGB sobre los datos de entrenamiento.
