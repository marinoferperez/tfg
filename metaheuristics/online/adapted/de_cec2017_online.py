...
from metaheuristics.online.algorithms.de_online import DifferentialEvolutionOnline
...
class DifferentialEvolutionCEC2017Online(DifferentialEvolutionCEC2017):
    ...
    def optimize(
        ...
        try:
            ...
            ruta_base = None
            if ruta_metricas is not None and (registrar_metricas or guardar_decisiones_subrogado):
                if run_id is None:
