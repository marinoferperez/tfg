...
from metaheuristics.offline.algorithms.de import DifferentialEvolution
...
class DifferentialEvolutionCEC2017:
    ...
    def optimize(self, funcid, dim, seed = 42, lib_path = None, algname = "de_cec", registrar_metricas = False, ruta_metricas = None, run_id = None, cec_workdir = None):
        seed = int(seed)
        self.de.seed = seed
