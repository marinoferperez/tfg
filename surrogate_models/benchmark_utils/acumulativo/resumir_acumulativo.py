...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Consolida los resultados del benchmark acumulativo para una funcion "
...
def main():
    ...
    generar_resumenes_genericos(
        ...
        benchmark_dir,
        problema,
        nombre_csv=f"resumen_benchmark_acumulativo_{problema}.csv",
        nombre_json=None if args.no_json else f"resumen_benchmark_acumulativo_{problema}.json",
        payload_extra={"protocol": "acumulativo"},
    )
    ...
    generar_analisis_por_batch(
        ...
        benchmark_dir,
        problema,
        prefijo_resumen="resumen_benchmark_acumulativo",
        payload_extra={"protocol": "acumulativo"},
