...
from surrogate_models.benchmark_utils.benchmark_paths import resolver_rutas_batch_modelo
    ...
    metricas_batch.update(
        {
            ...
            "future_validation": metricas.get("future_validation"),
...
def imprimir_resumen(metricas):
    ...
    print(f"validation_ratio: {metricas['validation_ratio']}")
    print(f"scale_features: {metricas.get('scale_features')}")
    print(f"scale_target: {metricas.get('scale_target')}")
